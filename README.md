...
# 🎮 Deliria — Community Edition

**Standalone Community Edition of the psychological horror adventure Deliria.**
...
Deliria is a psychological horror adventure set in a shifting, dreamlike world where perception is unreliable and every choice shapes the outcome. This Community Edition is a standalone build delivered as a self-contained package. It runs offline with no storefront required and is ready to play immediately after installation.

This build is for players who want a complete, self-contained offline version of Deliria that runs without a storefront.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3725650/e56253a0b3627b732558038534687e1e1d740117/ss_e56253a0b3627b732558038534687e1e1d740117.1920x1080.jpg?t=1788840221" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3725650/e88f74e9c2157ba71fbb6701b2c5e285b45d0df4/ss_e88f74e9c2157ba71fbb6701b2c5e285b45d0df4.1920x1080.jpg?t=1788840221" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3725650/25a331e5ab9acc986a03fe35b678dcb6beda505c/ss_25a331e5ab9acc986a03fe35b678dcb6beda505c.1920x1080.jpg?t=1788840221" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🌒 **Atmospheric psychological horror** — A tense, dreamlike world built on unreliable perception and shifting environments.
- 🧠 **Narrative-driven gameplay** — Branching story paths where choices influence endings and character fates.
- 🎨 **Hand-crafted environments** — Detailed, stylized locations rendered with a distinctive visual identity.
- 🎧 **Dynamic audio design** — Reactive soundscape that adapts to player state and in-game events.
- 🕹️ **Full controller support** — Playable with keyboard and mouse or a gamepad, remappable in settings.
- ⚙️ **Extensive graphics options** — Scalable presets and individual settings for a wide range of hardware.
- 💾 **Self-contained package** — No additional software required — the build runs entirely offline.
- 🌍 **Multiple interface languages** — Localized menus and subtitles included in the package.
...
- Deliria - Original Soundtrack
- Deliria - Digital Artbook
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 660 2 GB / AMD Radeon HD 7850 | NVIDIA GeForce GTX 1060 6 GB / AMD Radeon RX 580 |
| **Storage** | 12 GB available space | 12 GB on SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 12, headphones recommended for audio experience |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Deliria\Saved`
